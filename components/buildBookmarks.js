export function BuildBookmarks(questions) {
    // Build Cards dynamically via JS

    const mainSection = document.querySelector('[data-js="main-section-bookmarks"]');
    ...
    questions.forEach((card, index) => {
        ...
        if (questions[index].isBookmarked) {
            ...
            image.setAttribute("data-js", "button__bookmark-index");
